...
import { FaSearch, FaShoppingCart, FaTimes, FaSignOutAlt, FaUser } from "react-icons/fa";
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:block flex-grow max-w-2xl mx-4">
            <form onSubmit={handleSearch} className="relative">
              <div className="flex items-center rounded-full overflow-hidden transition-all duration-300 focus-within:ring-2 focus-within:ring-blue-400">
                <input
                  ref={searchInputRef}
                  value={searchTerm}
                ...
                <ul className="absolute z-10 w-full bg-white mt-1 rounded-md shadow-lg">
                  {searchSuggestions.map((suggestion) => (
                    <li
                      ...
                      className="px-4 py-2 cursor-pointer hover:bg-white" // Ensure no grey background on hover
                    >
                      {suggestion.name}
                    </li>
                  ))}
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <button onClick={handleLogoutWithClear} className="text-gray-100 hover:text-[#33DDFF] px-3 py-2 rounded-md text-sm font-semibold tracking-wide transition-colors duration-200 flex items-center">
          ...
          <div className="flex md:hidden">
            <button
              onClick={toggleMenu}
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-[#33DDFF] hover:bg-transparent focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#33DDFF]"
            >
              {isOpen ? (
      ...
      >
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <button 
            ...
            className="text-gray-800 hover:text-[#33DDFF] block w-full text-left px-3 py-2 rounded-md text-base font-semibold tracking-wide flex items-center"
          >
